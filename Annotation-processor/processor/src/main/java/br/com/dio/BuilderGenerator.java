...
public class BuilderGenerator {
    public TypeSpec create(final String packegeName, final String className,
        ...
        fields.forEach((k, v) -> generatedBuilderClass.addMethod(
                genBuilderSetter(
                        packegeName,
                        builderName,
                        k,
        ...
        var buildMethod = MethodSpec.methodBuilder("build")
                .addModifiers(Modifier.PUBLIC)
                .returns(ClassName.get(packegeName, className))
